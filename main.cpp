...
int main() {
    ...
    arr.resize(16);
    std::cout << "bitarray : " << arr.to_string() << std::endl;
    ...
    std::cout << "b1: " << b1.to_string() << std::endl;  // Output bit-representation of b1
...
//    std::cout << "b1: " << b1.to_string() << std::endl;  // Output bit-representation of b1
    ...
    std::cout << "b2: " << b2.to_string() << std::endl;  // Output the bit representation of b2
    std::cout << "b1: " << b1.to_string() << std::endl;  // Output bit-representation of b1

    BitArray b3 = b1 & b2;  // Perform bitwise AND operation between b1 and b2
    std::cout << "b1 & b2: " << b3.to_string() << std::endl;  // Output the bit representation of the result

    BitArray b4 = b1 | b2;  // Perform bitwise OR operation between b1 and b2
    std::cout << "b1 | b2: " << b4.to_string() << std::endl;  // Output the bit-representation of the result

    BitArray b5 = b1 ^ b2;  // Perform bitwise XOR operation between b1 and b2
    std::cout << "b1 ^ b2: " << b5.to_string() << std::endl;  // Output the bit-representation of the result
